...
public class AshiGuruma extends YouTubeBaseActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ashi_guruma);

        botaoHome = (ImageView) findViewById(R.id.botaoHomeId);
        botaoHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(AshiGuruma.this, MainActivity.class));
            }
        });
        ...
        botaoDicionario.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(AshiGuruma.this, Dicionario.class));
            }
        });
        ...
        botaoHistoria.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(AshiGuruma.this, Historia.class));
            }
        });
        ...
        botaoExameDeFaixa.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(AshiGuruma.this, ExameDeFaixa.class));
            }
        });
        ...
        botaoTecnicas.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(AshiGuruma.this, Tecnicas.class));
            }
        });



        youTubePlayerView = findViewById(R.id.video_ashi_guruma_id);
    ...
    public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer youTubePlayer, boolean foiRestaurado) {
        ...
        if (!foiRestaurado) {
            youTubePlayer.cueVideo("al7WFnhAj-Y");
        }
    }
