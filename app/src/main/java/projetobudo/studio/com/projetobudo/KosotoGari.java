...
public class KosotoGari extends YouTubeBaseActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kosoto_gari);

        botaoHome = (ImageView) findViewById(R.id.botaoHomeId);
        botaoHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(KosotoGari.this, MainActivity.class));
            }
        });
        ...
        botaoDicionario.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(KosotoGari.this, Dicionario.class));
            }
        });
        ...
        botaoHistoria.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(KosotoGari.this, Historia.class));
            }
        });
        ...
        botaoExameDeFaixa.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(KosotoGari.this, ExameDeFaixa.class));
            }
        });
        ...
        botaoTecnicas.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(KosotoGari.this, Tecnicas.class));
            }
        });



        youTubePlayerView = findViewById(R.id.video_kosoto_gari_id);
    ...
    public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer youTubePlayer, boolean foiRestaurado) {
        ...
        if (!foiRestaurado) {
            youTubePlayer.cueVideo("ZaiDTvVqhq4");
        }
    }
