...
public class VenhaNosConhecer extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_venha_nos_conhecer);

        botaoHome = (ImageView) findViewById(R.id.botaoHomeId);
        botaoHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(VenhaNosConhecer.this, MainActivity.class));
            }
        });
        ...
        botaoDicionario.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(VenhaNosConhecer.this, Dicionario.class));
            }
        });
        ...
        botaoTecnicas.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(VenhaNosConhecer.this, Tecnicas.class));
            }
        });
        ...
        botaoExameDeFaixa.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(VenhaNosConhecer.this, ExameDeFaixa.class));
            }
        });
        ...
        botaoHistoria.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(VenhaNosConhecer.this, Historia.class));
            }
        });
