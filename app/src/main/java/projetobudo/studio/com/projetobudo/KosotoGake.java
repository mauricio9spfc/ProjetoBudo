...
public class KosotoGake extends YouTubeBaseActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kosoto_gake);

        botaoHome = (ImageView) findViewById(R.id.botaoHomeId);
        botaoHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(KosotoGake.this, MainActivity.class));
            }
        });
        ...
        botaoDicionario.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(KosotoGake.this, Dicionario.class));
            }
        });
        ...
        botaoHistoria.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(KosotoGake.this, Historia.class));
            }
        });
        ...
        botaoExameDeFaixa.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(KosotoGake.this, ExameDeFaixa.class));
            }
        });
        ...
        botaoTecnicas.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(KosotoGake.this, Tecnicas.class));
            }
        });



        youTubePlayerView = findViewById(R.id.video_kosoto_gake_id);
    ...
    public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer youTubePlayer, boolean foiRestaurado) {
        ...
        if (!foiRestaurado) {
            youTubePlayer.cueVideo("mHhccqTONjM");
        }
    }
