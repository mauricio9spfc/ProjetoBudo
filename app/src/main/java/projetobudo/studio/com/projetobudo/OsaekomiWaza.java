...
public class OsaekomiWaza extends YouTubeBaseActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_osaekomi_waza);

        botaoHome = (ImageView) findViewById(R.id.botaoHomeId);
        botaoHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(OsaekomiWaza.this, MainActivity.class));
            }
        });
        ...
        botaoDicionario.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(OsaekomiWaza.this, Dicionario.class));
            }
        });
        ...
        botaoHistoria.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(OsaekomiWaza.this, Historia.class));
            }
        });
        ...
        botaoExameDeFaixa.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(OsaekomiWaza.this, ExameDeFaixa.class));
            }
        });
         ...
         @Override
         public void onClick(View view) {
         startActivity(new Intent(OsaekomiWaza.this, Tecnicas.class));
               }
         });



        youTubePlayerView = findViewById(R.id.video_osaekomiwaza_id);
    ...
    public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer youTubePlayer, boolean foiRestaurado) {
        ...
        if (!foiRestaurado) {
            youTubePlayer.cueVideo("m-JmQTw0OMo");
        }
    }
